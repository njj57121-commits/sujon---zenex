...
BOT_TOKEN = "8998886231:AAGH9GykGBws5nzvqeRySM7P1t6uWQ8FSA8"
API_KEY = "ZNX_XGET4TJYY58YZLJSR5448UDB"  # জেনেক্স এপিআই কী
...
WELCOME_MESSAGE = "✨ <b>WELCOME TO FREE NUMBER BOT</b> ✨\n━━━━━━━━━━━━━━━━━━━━━━\n🚀 <b>START INSTANT OTP RECEPTION NOW!</b> 🚀"
...
def load_settings():
    if not os.path.exists(SETTINGS_FILE):
        default = {
            ...
            "force_join_channels": ["https://t.me/Otp_recivedbot"], # ফোর্স জয়েন চ্যানেলসমূহ
...
async def support_command(update: Update, context: ContextTypes.DEFAULT_TYPE):
    ...
    keyboard = InlineKeyboardMarkup([
        ...
        [InlineKeyboardButton("👨‍💻 DEVELOPER", url="https://t.me/Sujon2", style="primary")]
    ])
                    ...
                    if (num in active_numbers and 
                        ...
                        user_otp_keyboard = InlineKeyboardMarkup([
                            ...
                            [
                                ...
                                InlineKeyboardButton("✔️ NUMBER ↗", url="https://t.me/Sujon2", style="primary")
                            ]
                        ])
                        ...
                        group_buttons = InlineKeyboardMarkup([
                            [
                                InlineKeyboardButton("‼️ Developer", url="https://t.me/Sujon2", style="danger"),
                                InlineKeyboardButton("📢 CHANNEL", url=channel_url, style="primary")
                            ]
                        ])
